...
const StaffOrders = () => {
    ...
    return (
      <div className="staff-order-status-select">
        <select
          ...
          aria-label={`Update ${getOrderNumber(
            order
          )} status`}
        >
  ...
  const renderPaymentBadge = (order) => {
    ...
    return (
      <div
        className={`staff-order-payment-badge payment-${paymentStatus}`}
      >
        <Icon />
  ...
  return (
    <div className="staff-orders-page">
      ...
      <div className="staff-orders-header">
        <div>
          <span className="staff-orders-eyebrow">
            SALES MANAGEMENT
          </span>
          ...
          <p>
            Manage POS orders, payments and order
      ...
      <div className="staff-orders-stat-grid">
        <motion.div
          className="staff-orders-stat-card"
          whileHover={{ y: -3 }}
        >
                        ...
                        >
                          ...
                          <td>
                            <button
                              ...
                              aria-label={`View ${getOrderNumber(
                                order
                              )}`}
                            >
                              <FaEye />
