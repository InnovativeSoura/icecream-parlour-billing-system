...
const Products = () => {
  ...
  const fetchCategories = async () => {
    try {
      ...
      console.error("Customer categories error:", err);
  ...
  const cartTotal = Number(grandTotal || 0);
      ...
      <div className="customer-products-container">
        ...
        {loading && (
          <div className="customer-products-state">
            ...
            <h3>Loading delicious treats...</h3>

            <p>We're preparing the menu for you.</p>
          </div>
        )}
                  ...
                  >
                    <div className="customer-product-image">
                      ...
                      <div className="customer-product-image-overlay">
                        <span>{categoryName || "Ice Cream"}</span>
                      </div>
