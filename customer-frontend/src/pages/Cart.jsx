...
const MyCart = () => {
  ...
  const gstPercentage = Number(gstRate ?? 18);
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      createdOrderId = createdOrder?._id || createdOrder?.id || null;
      ...
      const paymentData = razorpayResponse?.data?.data;
      ...
      if (!paymentId || !orderId || !razorpayOrderId || !keyId || !amount) {
      ...
      >
        <div className="my-cart-header">
          <div>
            ...
            <p>Review your favourite treats before checkout.</p>
          </div>
        ...
        <div className="my-cart-layout">
          ...
          >
            ...
            <div className="my-cart-payment-methods">
              ...
              <div>
                <div className="my-cart-payment-method" title="UPI">
                  UPI
                </div>

                <div className="my-cart-payment-method" title="Cards">
                  <FaCreditCard />
                </div>

                <div className="my-cart-payment-method" title="Wallets">
                  <FaWallet />
                </div>
              </div>
            </div>
